...
@Data
@Entity
@Table(name = "go_role_resource_relation")
public class GoRoleResourceRelation implements Serializable {
    ...
    @Column(name = "resource_code", nullable = false, columnDefinition = "varchar(200)")
